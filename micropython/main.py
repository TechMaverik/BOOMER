...
def closeEyes():
    fb = framebuf.FrameBuffer(TH2,128,64, framebuf.MONO_HLSB)
    oled.fill(0)
    oled.blit(fb,0,0)
    oled.show()
    Actuator.led.toggle()
    ...
    while True:        
        ...
        if(sensor.value()==0):
            ...
            if(action[r1]=="pushup"):
                ...
                print("Greetings")                
                fb = framebuf.FrameBuffer(TH5,128,64, framebuf.MONO_HLSB)
                oled.fill(0)
                oled.blit(fb,0,0)
                oled.show()
                count=0
        ...
        if uart.any():
            ...
            if(data=="q"):
                ...
                if(emotionalStatus==True):
                    ...
                    Buzzer.playsong(song2)
                    fb = framebuf.FrameBuffer(TH4,128,64, framebuf.MONO_HLSB)
                    oled.fill(0)
                    oled.blit(fb,0,0)
                    oled.show()
                    time.sleep(4)
                    ...
                    Buzzer.playsong(song4)
                    print("He is Idle")
                    fb = framebuf.FrameBuffer(TH6,128,64, framebuf.MONO_HLSB)
                    oled.fill(0)
                    oled.blit(fb,0,0)
                    oled.show()
                    time.sleep(4)
                    ...
                    Buzzer.playsong(song3)
                    print("Drink Water")                
                    fb = framebuf.FrameBuffer(TH7,128,64, framebuf.MONO_HLSB)
                    oled.fill(0)
                    oled.blit(fb,0,0)
                    oled.show()
                    count=0
